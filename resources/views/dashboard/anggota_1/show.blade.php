...
<div class="card">
    ...
    <div class="card-body">
        <div class="card-title fs-4">{{ $anggota->nama }}  @if($anggota->status==1)<div class="float-end text-primary"><i class="bi bi-patch-check-fill"></i> Diverifikasi</div> @else <div class="float-end" style="color: darkgray;"><i class="bi bi-patch-check-fill"></i> Belum Diverifikasi</div>@endif</div>
